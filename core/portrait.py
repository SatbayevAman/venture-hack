...
2. Как решает: доли методов по квадратным уравнениям (methods) и по каждому навыку
   (methods_by_skill: метод интервалов, подстановка, замена переменной…), частота привычек.
