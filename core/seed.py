...
EXTRA_ASSIGNMENTS = [
    ...
    {"number": 10, "title": "ДЗ №10 «Биквадратные уравнения»", "due": "2026-10-06 23:59", "problems": [
        ("biquadratic", "biquadratic", "x⁴ − 5x² + 4 = 0",
         ["Пусть x² = t, t ≥ 0", "t² − 5t + 4 = 0", "D = 25 − 16 = 9", "t₁ = (5 + 3)/2 = 4", "t₂ = (5 − 3)/2 = 1",
          "x² = 4 или x² = 1", "x = ±2, x = ±1", "Ответ: −2; −1; 1; 2"], "−2; −1; 1; 2"),
        ("biquadratic", "biquadratic", "x⁴ + 2x² − 3 = 0",
...
# Демо-работы Айгерим по новым темам для кнопки «Вставить демо-работу»: номер ДЗ → {задача: строки}.
# ДЗ №8 (docs/beta.md, «Демо ДЗ №8»): №1 — разделила на −3 и не сменила знак, №2 — верно методом
# интервалов, №3 — граница −1 вне ОДЗ попала в ответ.
EXTRA_DEMO_TEXT = {
    8: {1: "−3x < 11 − 2\n−3x < 9\nx < −3\nОтвет: (−∞; −3)",
        2: "x² − x − 6 = 0\nx₁ = 3, x₂ = −2\n+ − +\nОтвет: [−2; 3]",
        3: "x₁ = 3, x₂ = −1\nОтвет: (−∞; −1] ∪ [3; +∞)"},
...
EXTRA_VARIANTS = {
    ...
    10: {
        1: {"pm": ["Пусть x² = t", "t² − 5t + 4 = 0", "t₁ = 4, t₂ = 1", "x² = 4 или x² = 1", "x = 2, x = 1", "Ответ: 1; 2"]},
